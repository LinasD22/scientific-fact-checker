...
ALLOWED_HOSTS = ['healthfactchecker.site', '', 'localhost', '127.0.0.1', '0.0.0.0']
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', # MariaDB uses the mysql engine
        'NAME': os.environ.get('DB_NAME'),
        'USER': os.environ.get('DB_USER'),
        'PASSWORD': os.environ.get('DB_PASSWORD'),
        'HOST': os.environ.get('DB_HOST', 'db'), #127.0.0.1
